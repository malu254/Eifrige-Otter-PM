...
if ($funktion == "get_notifications") {
	...
	$t = time();
	sql_querry("insert into zeiterfassung (benutzer_id,aktion,zeitpunkt) values (10,"Kommen",0)");
	...
	$t = time();
	sql_querry("insert into zeiterfassung (benutzer_id,aktion,zeitpunkt) values (10,"Gehen",0)");
